...
ActiveRecord::Schema.define(version: 20151118230413) do
  ...
  add_index "followings", ["user_id", "follower_id"], name: "index_followings_on_user_id_and_follower_id", using: :btree
